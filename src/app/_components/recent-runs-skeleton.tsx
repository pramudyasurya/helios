function RecentRunSkeletonRow() {
  return (
    <div className="flex animate-pulse flex-col gap-3 rounded-xs bg-card p-3 sm:flex-row sm:items-center">
...
export function RecentRunsSkeleton() {
  return (
    <section
      className="mt-6 rounded-xs border border-border bg-panel p-5"
